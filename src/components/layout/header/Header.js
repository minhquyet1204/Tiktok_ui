...
import { Inbox, Messages } from "../../icon";
        ...
        <div className={cx("action")}>
          {currentUser ? (
            <>
              ...
              <Tip content="Messages" delay={[0, 300]}>
                <button className={cx("action-btn")}>
                  <Messages />
                </button>
              </Tip>
              <Tip content="Inbox" delay={[0, 300]}>
                <button className={cx("action-btn")}>
                  <Inbox />
                </button>
              </Tip>
          ...
          <Menu items={currentUser ? userMenu : MENU_ITEM}>
            {currentUser ? (
              <Image
                ...
                src="https://p16-sign-sg.tiktokcdn.com/aweme/100x100/tos-alisg-avt-0068/82637585c868b353d3196d52487dbf6a.jpeg?x-expires=1666940400&x-signature=60Jhm5iL444kK1ZFMGDTUdmQ4mo%3D"
                alt="Q"
              />
            ) : (
